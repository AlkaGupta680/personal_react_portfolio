    ...
    <section id="home" className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      ...
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start">
        <AnimatedText className="flex flex-col items-center sm:items-start gap-4">
          <Image
            ...
            src="/avataar.jpg" // Replace with your avatar image path in public folder
            alt="Profile Picture"
            width={120}
            height={120}
            priority
          />
          <h1 className="text-4xl font-bold">Alka</h1>
        ...
        >
          ...
          I'm Alka, a pre-final year B.Tech student majoring in Electronics and Communication Engineering at IGDTUW, Delhi. I’m passionate about software development and actively building my skills in full-stack development and data structures. Currently, I’m seeking opportunities to grow as a Software Development Engineer by working on challenging, real-world projects.
        ...
        >
          <a
            ...
            "
            href="https://github.com/AlkaGupta680" // Replace with your GitHub profile link
            target="_blank"
          ...
          <a
            ...
            "
            href="https://drive.google.com/drive/folders/1HBheqi7WcyuDbM5MlWiKmteqL_U0smvA?usp=drive_link" // Replace with your resume PDF path in public folder
            target="_blank"
          >
            <Image
      ...
      >
        <a
          ...
          href="mailto:galka3753@gmail.com" // Replace with your email address
        >
          <Image
            aria-hidden
        ...
        <a
          className="flex items-center gap-2 hover:underline hover:underline-offset-4"
          href="https://www.linkedin.com/in/alka-gupta123/" // Replace with your LinkedIn profile link
